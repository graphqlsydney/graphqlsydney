...
![right](https://www.dropbox.com/s/ih2m210eukkkntk/jean-jacques-dubray.png?dl=1)

# [fit] *A* **__GraphQL-based__**
# [fit] *Schema Architecture*
# [fit] *for* **Microservices**
# [fit] **__Jean-Jacques Dubray__**
# [fit] @metapgmr
...
^
The next meetup will be on May 11th, our cadence being the second Wednesday of the second month of each quarter. Probably still online but we'll see what the pandemic situation is like. But regardless, we'll announce on Twitter what we plan to do.
