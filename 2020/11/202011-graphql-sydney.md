...
![right](https://www.dropbox.com/s/mfojup0i2e5fhv9/robertson-taylor.jpg?dl=1)

# [fit] **_Production Ready_** *GraphQL*:
# [fit] *Rapid Development of*
# [fit] **_GraphQL_** *APIs*
# [fit] *using* **_AWS_**
# [fit] **_Robertson Taylor_**

^
First up we have Robertson Taylor, who will be talking about Rapid development of GraphQL APIs using Amazon AWS. Specifically, how you can build out a reliable, scalable, and extensible GraphQL API in a matter of minutes using AWS Amplify and AWS AppSync.

---
[.hide-footer]
[.slidenumbers: false]

![right](https://www.dropbox.com/s/lwr7flnk7hul3uo/bapu-sethi.jpg?dl=1)

# [fit] **_Batch queries_** *for* **_GraphQL_**
# [fit] *to* **_avoid_**
# [fit] **_N+1_** *issues*
# [fit] **_Bapu Sethi_**

^
Then, we have Bapu Sethi, who will do a lightning talk for us on the challenges GraphQL presents with regards to fetching association data, how it leads to N+1 database queries, and how to then avoid them.
...
^
The next meetup will be on February 10th, our cadence being the second Wednesday of the second month of each quarter, and will continue to be online only for the foreseeable future.
